...
Félév anyaga:
	...
	Ker világ
	Kat egyház
	Biblia, történelem, jog, erkölcs, leki élet, spiritualitás, életvezetés stb


Isten (nem) halott
Miért nem hagyja nyugodni a világot az isten kérdés?

Mikortól való a vallásosság?
	Tárgy mellétemetés
	Írásbeliség
...
Három nagy monoteista vallás.
	Zsidó
	Keresztény
	Iszlám

Újvallások
	sokféle ismerősebben csengő

Keresztény legalapvetőbb tanítása:
	Isten jött el az emberekhez.
...
Ateizmus
	...
	antievangélizáció
	hitviták
	a semmit/valamit/véletlen isten tuljaival ruházzák fel 

	"Richard Dawkins"
	"Sam Harris"
	"Danniel Denneit"

sivatag víz, ember isten --Kamu istenbizonyíték

szükségszerű valami természetfeletti része, valami istenszerű -- erős állítás

Van e Isten?
	I vatikáni zsinat (1870; DH 3004)
		*Zsinat: intézmény, vitáznak teológiai kérdésről, majd döntenek.
	Rómaiakhoz írt levél 1,20
...
Érvek
	[[1]] végtelenségig való visszavezetés
	[[2]] mindennek van oka ami visszavezethető
	[[3]] keletkezés -> elmúlás
	[[4]] Tökéletességi fokozatok: jó-rossz
	[[5]] Célirányos működés, rendszer működtető
...
Beadandó:
	...
	betüméret 12
	dec 1
	Subject: ''Pázmány beadandó''
	hodaszandras@gmail.com
	...
	Könyvlista
		...
		"Gabriele Kuby"
			Globális szexuális forradalom
		"Mary Eberstadt"
			Ádám és Éva a tabletta után
		"Dominik Klenk"
			A nemek összezavarása
		"Christopher West"
			Boldogságkeresés és szexualitás
...
"Charles Darwin"
	...
	föld körülöli út -> botanikusként

	természetes kiválasztódás
		a természetes kiválasztódás a legfontosabb, de nem kizárólagos eszköze a fejlődésnek
			ergo nem zárja ki istent
		a legalkalmasabb éli túl
		populációs drift
	van változás
	Nincs célirányos fejlődés

	nem ad a ... kérdésre választ
		kezdet
		komplexitás
		kozmikusan értelmezett evulóció

	Következmények (-)
		félremagyarázások
		szélsőségesen creationista elmélet
		fasizmus, nácizmus
...
"Stephen Hawking"
	...
	Világegyetem nem állandó
		tágul a Világegyetem
		ősrobbanás vízhangja
	...
	A valóság képét látjuk csak, a valóság nem megismerhető
	Ha Istent tekíntjük válasznak csupán egy rejtéjt helyettesítunk a másik helyére.
	A föld forog a Nap körül - vs szentítrás
	A viselkedésünket törvényeket határozza meg, nincs szabadakarat. (rendszeren belüli indok, hipotézis)
	Biológiai gépek vagyunk - nincs szabad akarat (rendszeren belüli indok, hipotézis)
	Agnosztikus
...
Mit tanít a Biblia?
	A világot Isten teremtette
		...
		szabad akaratából teremtette

Utak Istenhez
	"I. Kant": ''Isteni törvény bennem.''
	Oka van a világnak. És vannak léttöbletek.
	''Véges ismeret'', ''végtelen'' vágy.
	Személyes Isten tapasztalatok

Istenképek

Vallások
	latin relégio
		újraolvasás, kötődni kapcsolódni, újraválasztás (paradicsomi kiűzés->újra őt választjuk)
Mágia
	Isteni erő - hatalom, uralkodás felette
