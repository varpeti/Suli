Könyv: Közgazdaságtani bevezetés

Nincs névsor

Blablablablablbalbalalbalbalabalbalaabalbabalabalablaabllabalabalabl
10:40
Blablablablablbalbalalbalbalabalbalaabalbabalabalablaabllabalabalabl

Kapitalizmus tudománya a Közgazdaságtan

Természetjog:
	Közgazdaságtan
		"Adam Smith": A nemzetek gazdagsága 1776 --An Inquiry into the Nature and Causes of the Wealth of Nations
		Kaptitalizmus 19.sz
			Hitel erkölcsi kérdése
			Részvénytársaságok -> tőzsdék -> tőzsde válság
			innovációk

			hol és miért működik, miért nem?
					"Jesús Huerta de Soto" -- H. Soto
						Perui közgazdász
			megsokszorozódás
			hasznok
			tőke vs vagyon <->  tulajdonjog bizonytalansága
								jogkövető magatartás

			végtelen növekedés, véges környezetben

			[[1]] folyamatos innovációk
			[[2]] időérzékenység
			[[3]] irgység

			tervgazdaság oldaláról nézve nagyobb a kontur

			Vallás, kultúra befolyásolja nagyban
				"Max Weber": A protestáns etika és a kapitalizmus szelleme
				tradicionális, szükséglet fedezés <-> vagyon felhalmozás, növekedés

	Szociológia - "Auguste Comte"
	Politológia - "Alexis de Tocqueville"
	Demográfia - "Thomas Robert Malthus"
...
2 nagy ág
	Foszilista
		Megalapozott következtetések a pontos tények vizsgálatából
	Normatív
		Értékalapú döntések meghozatala

"Gossen" első törvénye:
	Egy adott élvezet nagysága csökken, ha ezt az élvezetet megszakítás nélkül, folyamatosan elégítjük ki addig, amíg telítettség nem lép fel.
...
Valódi pénz vs érték -> pénzügyi lufi
...
Kereslet-kínálat
	kereslet nö ár nő exp
	kínálat nő ár csökken exp
...
Kapitalizmus
	Rövidtávú
		tervezés
		gyors változás <> innovációk

Csendes generáció vagyunk (mi)
	Válság világ
		deviza
		migráns
		stb
	Nyugalmat, bizonságot akarunk

Első közgazdaságtani iskola
	Merkantilista
		Kereskedők
		Gyakorlati embernek
...
Merkantilisták
	ha nagyobb az export nagyobb a bejövő nemesfém (növekedés)
	-> aktív külkereskedelmi mérleg
	"Thomas Mun"
		Kereskedelem fejlesztés
		Tőkenövelés
		Ipar fejlesztés -> mezőgazdaság rovására
		aktív külkereskedelmi politika
		vámhatárok

	Colbertizmus
		francia Merkantilizmus

 		kevésbé sikeres a nagy mezőgazdaság miatt
 		vámhatár -> ellenvámhatár
 		monopoljogok -> állami (sikertelen)
 		Luxus Ipar sikeres (parfümök kozmetikumok)

 	Kameralizmus
 		Ausztria
 		''Kamara haszna''
 		komplementer gazdaságok

 		Szétverik ezt Trianonnal

 	"Bethlen Gábor"
 		Erdély aranykora
 		mezőgazdaság helyett -> Ipar
 		Liberális -> vallás szabadság -> jó iparosok, kereskedők

Dogmatizmus -> válság -> Pragmatizmus -> Dogmatizmus -> stb

Egyensúly vs növekedés
...
Fiziokrata
	= természet tudomány
	mezőgazdaság
	Örök törvényszerűségeket próbálják leírni
		Tér-idő független emberi érzet
			Tulajdon jog
	...
	"François Quesnay"
		...
		mezőgazdaság a futóágazat
			-> kevésmagból sok, kevés disznóból sok
		mezőgazdasági forradalom
			eddig a mezőgazdaság korlátozta a demográfiát, meg a pestis meg a háborúk
	krumpli, kukorica, paprika, paradicsom
	

Zöldforradalom 1.0
	Függetlenítés a természetől a termelés

	tojó hybrid
	hús hybrid

Zöldforradalom 2.0
	Technológia függősségek
	GM
	Jogi gazdaság: kisajátított élőlények

"Adam Smith"
	A nemzetek gazdagsága 1776 --An Inquiry into the Nature and Causes of the Wealth of Nations
	Manufaktúra
		Termelékenységi robbanás
		Munkamegosztás
		Futószallag elődje
	Az elvégzett munka mennyísége gazdagítja az országot

	Szabadság - rabság fokok
	Önzés a gazdaságban vs rend a gazdaságban
		egymás szükségleteit elégítjük ki -> rend
		''láthatatlankéz''
		Homo ökonomikus
	Monopólium ellenes
		monopoljogok nem jók
	államszervezés ellenes
		közbiztonság szerepe
		oda ahol nem kell verseny
		''éjjeliőr állam''
		nem avatkozhat be az állam
...
"David Ricardo"
	1800-as évek eleje
	Miliumos
	Gyakorlatban szerzett tapasztalat
	"Adam Smith"-et olvas
	A kor változásaira reflektál
	Politikai hatalom vs Iparos hatalom

	1) Szabadkereskedelem elmélet
		Gabonavám nőtt (politikai döntés alapján)
			-> Nőttek az élelmiszer árak
				-> Nőt a megélhetés ára
					-> ellenezte
		Mindenki kapcsolódjon be a piacra, még ha szegényebb is
	2) Abszolut előny
	3) Komparative előny
						Anglia					Fr
		1m posztó		 10h 					20h
		...
		Kritika:
			Nem lehet homogénnek tekinteni országokat / embert
			Pillanyatni helyzet alapján, kell specializálódni az innovációkat figyelmen kívül hagyva

	Mindig az a Szabadkereskedelem párti aki a legversenyképesebb.

Protekcionisták
	"Friedrich List"
		kellenek a kereskedelmi védelmek
	Jövőorientáltabb
	Dinamikusabb
	Külső hatások ellen van.

Szabadkereskedelem (1) vs protekcionizmus (2)
	1 statikus
	1 kiszolgáltatottság
	1 antidiverzitás

	Dinamikus hozzáállás kell
		nevelő vám
			2 -> 1
			egyre jobban szedik le a korlátokat
			folyamatos nyitás a külker felé

	2 könnyen átfordul a izonacionalizmusba (Észak-Kórea)
	1 "David Ricardo"
	2 "Friedrich List"
	2 100ft külföldi - 120ft magyar
		fogyasztó vagy vállalkozó szemszögéből

	Miért jó a globalizáció:
		1) Abszolut hiány: pl narancs MO-n
			Import kell belőle

		2) Diferenciál termék 
			termék választék
				pl autók
		verseny nő
	...
	Miért jó a protekcionizmus
		1) Hazai vállalkozók védelme
			a plusz költség sok fogyasztó között oszlik meg.
		2) Stratégia termékek
		3) Nevelő vámok
		4) Jövőorientáltabb

Kicsi nyitott gazdaság
	export/GDP*100=x%
	Minnél kisebb egy ország annál jobban rászorul a külkereskedelemre
	exportárindex/importárindex>=1 a jó
	rugalmas átlendülés a kihívásokon

Kereskedelem politikai eszközök:
	1) vám
		diszkrimináció
		Csop
			import vám - gyakori
		...
		Csop
			...
			Védővám 
				nevelő vám
				piacvédelmi vám
				taktikai vám (retorziós vám)
				A mennyiségi korlátozás
				bizonyos mennyiségi felett nem lehet behozni
				GATT 1947-95 -> WTO 1995-
				Egyezmények
					TTIP : USA-Eu (Orosz ellen)
					TPP : USA-Távkel (Kína ellen)
	2) Önkéntes export korlátozás
		''Önként'' hogy ne szorítsák ki
	3) Nem tarifális eszközök
		Fogyasztóvédelem
		Környezetvédelem
		Állatvédelem
		stb
		-- PL Német sörtisztasági törvény
		-- PL MO versenyképes libamáj, liba tömés elleni állatvédelem.
		Piacvédelem, és profitérdek
	4) Árfolyam politika
		átmeneti megoldás
